...
class EpochBasedTrainer(BaseTrainer):
    ...
    def train_epoch(self):
        ...
        for iteration, data_dict in enumerate(self.train_loader):
            ...
            # mms.append(output_dict['mms_time'])
            # rms.append(output_dict['rms_time'])
            # tms.append(output_dict['tms_time'])
            # print('MMS:',np.mean(mms))
            # print('RMS:',np.mean(rms))
            # print('TMS:',np.mean(tms))
            # print('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
            # time.sleep(5)


            # wandb.log({
            #     "mms": output_dict['mms_time'],
            #     "rms": output_dict['rms_time'],
            #     "tms": output_dict['tms_time'],

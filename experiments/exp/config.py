...
_C.coarse_matching.num_correspondences = [64, 32, 16, 8, 4]  ## TMS
...
# model  - MultiScaleCorrelation  ## TMS
_C.multi_scale_corr = edict()
_C.multi_scale_corr.scale = [2, 3, 4, 5]
_C.multi_scale_corr.pre_scales = [0, 0, 0]
_C.multi_scale_corr.scale_index = 1
_C.multi_scale_corr.co_scale = [8, 16, 32]
